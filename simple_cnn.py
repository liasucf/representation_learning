...
def create_model_CNN(n_classes, glv_embedding_matrix, cnn_output_size, max_num_tokens, filters, kernel_sizes, dropout,
    ...
    dense = k.layers.Dense(n_classes, activation="sotmax", kernel_regularizer='l2')
    ...
    #Add a last neural network to compute the probability scores
...
"Function to predict the test data with the trained CNN model"
